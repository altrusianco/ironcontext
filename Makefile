...
.PHONY: all build release test test-rust test-bench test-optimizer test-python \
        test-action clean fmt fixtures help
...
help:
	...
	@echo "  make test          Full verification: cargo + bench + optimizer + python + action."
...
test: test-rust test-bench test-optimizer test-python test-action
	@echo ""
